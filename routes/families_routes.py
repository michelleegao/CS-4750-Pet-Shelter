...
@families_bp.route("/families/<family_id>")
def families_view(family_id):
    ...
    try:
        ...
        if not row:
            ...
            return redirect(url_for("families.families"))
...
def families_add():
    ...
    try:
        ...
        if not first_name or not last_name:
            ...
            return redirect(url_for("families.families_add"))
...
# edit families
@families_bp.route("/families/<family_id>/edit", methods=["POST"])
...
@families_bp.route("/families/<family_id>/delete", methods=["POST"])
